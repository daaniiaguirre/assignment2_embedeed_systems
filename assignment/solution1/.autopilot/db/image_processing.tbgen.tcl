...
set C_modelArgList {
	{ in_img int 8 regular {axi_slave 0}  }
	{ out_img int 8 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_img", "interface" : "axi_slave", "bundle":"AXI_CPU","type":"ap_memory","bitwidth" : 8, "direction" : "READONLY", "offset" : {"in":4096}, "offset_end" : {"in":8191}} , 
 	{ "Name" : "out_img", "interface" : "axi_slave", "bundle":"AXI_CPU","type":"ap_memory","bitwidth" : 8, "direction" : "WRITEONLY", "offset" : {"out":8192}, "offset_end" : {"out":12287}} ]}
...
set portList { 
	...
	{ s_axi_AXI_CPU_AWADDR sc_in sc_lv 14 signal -1 } 
	...
	{ s_axi_AXI_CPU_ARADDR sc_in sc_lv 14 signal -1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXI_CPU_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "AXI_CPU", "role": "AWADDR" },"address":[{"name":"image_processing","role":"start","value":"0","valid_bit":"0"},{"name":"image_processing","role":"continue","value":"0","valid_bit":"4"},{"name":"image_processing","role":"auto_start","value":"0","valid_bit":"7"},{"name":"in_img","role":"data","value":"4096"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "in_img", "Type" : "Memory", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	image_processing {
		...
		out_img {Type O LastRead -1 FirstWrite 1}}}
