...
// wrapc file define:
#define AUTOTB_TVIN_in_img "../tv/cdatafile/c.image_processing.autotvin_in_img.dat"
#define AUTOTB_TVOUT_in_img "../tv/cdatafile/c.image_processing.autotvout_in_img.dat"
#define AUTOTB_TVIN_out_img "../tv/cdatafile/c.image_processing.autotvin_out_img.dat"
#define AUTOTB_TVOUT_out_img "../tv/cdatafile/c.image_processing.autotvout_out_img.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_out_img "../tv/rtldatafile/rtl.image_processing.autotvout_out_img.dat"
...
extern "C"
void image_processing_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_image_processing_hw(void* __xlx_apatb_param_in_img, void* __xlx_apatb_param_out_img)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_in_img),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_in_img),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_in_img };
  port0.depth = { 2500 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_out_img),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_out_img),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_out_img),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_out_img),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_out_img),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_out_img),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_out_img };
  port1.depth = { 2500 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    image_processing_hw_stub_wrapper(__xlx_apatb_param_in_img, __xlx_apatb_param_out_img);
